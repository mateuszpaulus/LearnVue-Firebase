  ...
  <div class="create-post">
    ...
    <div class="container">
      ...
      <div class="post-actions">
        <button class="router-button" @click="updatePost">Update Post</button>
        <router-link class="router-button" :to="{ name: 'PreviewPostView' }"> Preview Changes</router-link>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  async mounted() {
    this.routeId = await this.$route.params.postId;
    this.currentPost = await this.$store.state.postsStorage.filter((post) => post.postID === this.routeId);
